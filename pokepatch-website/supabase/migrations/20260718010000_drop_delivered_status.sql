-- PokePatch: drop delivered status
--
-- Status set becomes: new (To do) | in_progress | completed
-- Existing delivered rows are moved to completed.
--
-- SAFETY
...
-- ---------------------------------------------------------------------------
-- update_order — stop accepting delivered
-- ---------------------------------------------------------------------------
