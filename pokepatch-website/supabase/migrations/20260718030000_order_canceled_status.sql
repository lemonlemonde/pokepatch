-- PokePatch: add canceled status
--
-- Status set: new | in_progress | completed | canceled
-- completed_at is stamped when an order becomes completed OR canceled.
--
-- SAFETY
...
alter table public.orders
  ...
  check (status in ('new', 'in_progress', 'completed', 'canceled'));
