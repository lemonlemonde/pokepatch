-- Keep update_order handling both per-card admin notes and workflow checklists.
-- Needed on databases where cards_admin_note was applied before cards_checklist.
