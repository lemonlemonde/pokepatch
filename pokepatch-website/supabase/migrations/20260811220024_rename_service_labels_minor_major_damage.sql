-- Rename create_order service labels to match marketing copy:
-- Flattening → Minor Damage, Heavy Damage → Major Damage.
-- Keep listPrice/title sync with src/lib/servicePricing.js QUOTE_SERVICES.
