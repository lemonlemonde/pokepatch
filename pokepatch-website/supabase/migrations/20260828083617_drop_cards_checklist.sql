-- Drop unused per-card photo/workflow checklist (Before/After/Social toggles).
-- Based on update_order from 20260812033510; strips checklist read/write.
...
ALTER TABLE public.cards DROP COLUMN IF EXISTS checklist;
