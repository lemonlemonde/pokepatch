-- PokePatch: orders.photos_drive_url for admin Google Drive folder links
--
-- SAFETY
-- - Additive column only; never touches quote_requests or *_original tables.
-- - Replaces update_order to accept the new field.
