...
const links = [
  {
    ...
    href: "https://www.instagram.com/pokepatch.cards/",
    Icon: InstagramIcon,
  },
  {
    label: "Discord",
  ...
  {
    label: "Email",
    value: "pokepatch.cards@gmail.com",
            ...
            {href ? (
              <a
                ...
                {...(href.startsWith("http")
                  ...
                  : {})}
                className="inline-flex items-center gap-1.5 transition hover:text-ink [&_span:last-child]:hover:text-ink"
              >
                {content}
              </a>
            ) : (
